...
public class TeacherMenu {
    ...
    public TeacherMenu(Teacher te) {
        ...
        ImageIcon i3 = new ImageIcon("picture/teacher.png");
    ...
    java.net.URL resourse4 = classLoader.getResource("picture");
    ImageIcon i3 = new ImageIcon(resourse4);
    ImageIcon ic1 = new ImageIcon(resourse4);
    ImageIcon ic2 = new ImageIcon(resourse4);
    ImageIcon ic3 = new ImageIcon(resourse4);
    ImageIcon ic4 = new ImageIcon(resourse4);
    ImageIcon ic5 = new ImageIcon(resourse4);
    ImageIcon ic6 = new ImageIcon(resourse4);
    ImageIcon ic7 = new ImageIcon(resourse4);
}
