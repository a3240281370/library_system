...
public class StaffMenu {
    ...
    public StaffMenu(Staff sf) {
        ...
        ImageIcon i3 = new ImageIcon("picture/employee.png");
    ...
    java.net.URL resourse2 = classLoader.getResource("picture");
    ImageIcon i3 = new ImageIcon(resourse2);
    ImageIcon ic1 = new ImageIcon(resourse2);
    ImageIcon ic2 = new ImageIcon(resourse2);
    ImageIcon ic3 = new ImageIcon(resourse2);
    ImageIcon ic4 = new ImageIcon(resourse2);
    ImageIcon ic5 = new ImageIcon(resourse2);
    ImageIcon ic6 = new ImageIcon(resourse2);
    ImageIcon ic7 = new ImageIcon(resourse2);
